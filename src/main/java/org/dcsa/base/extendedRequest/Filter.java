        ...
        try {
            ...
            if (fieldType.getEnumConstants() != null) {
                ...
                for (String enumItem : enumList) {
                    filters.add(FilterItem.addOrGroupFilter(fieldName, enumItem, true));
                }
            } else if (String.class.equals(fieldType)) {
                if ("NULL".equals(value)) {
                    filters.add(FilterItem.addExactFilter(fieldName, value, false));
                } else {
                    filters.add(FilterItem.addStringFilter(fieldName, value));
                }
            } else if (UUID.class.equals(fieldType)) {
                filters.add(FilterItem.addExactFilter(fieldName, value, !"NULL".equals(value)));
            } else if (Integer.class.equals(fieldType) || Long.class.equals(fieldType)) {
                filters.add(FilterItem.addExactFilter(fieldName, value, true));
